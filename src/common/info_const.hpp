...
_DECL_CONST SERVER_REGION_UE = "us-east";
_DECL_CONST SERVER_REGION_UW = "us-west";
_DECL_CONST SERVER_REGION_SA = "southamerica";
_DECL_CONST SERVER_REGION_EU = "europe";
_DECL_CONST SERVER_REGION_ASIA = "asia";
_DECL_CONST SERVER_REGION_AUS = "australia";
_DECL_CONST SERVER_REGION_ME = "middleeast";
_DECL_CONST SERVER_REGION_AFC = "africa";
