...
class CMsgClientWelcome : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_cstrike15_welcome() const;
  inline void clear_cstrike15_welcome();
  static const int kCstrike15WelcomeFieldNumber = 2;
  inline const ::CMsgCStrike15Welcome& cstrike15_welcome() const;
  inline ::CMsgCStrike15Welcome* mutable_cstrike15_welcome();
  inline ::CMsgCStrike15Welcome* release_cstrike15_welcome();
  inline void set_allocated_cstrike15_welcome(::CMsgCStrike15Welcome* cstrike15_welcome);
  ...
  inline bool has_gc2client_hello() const;
  inline void clear_gc2client_hello();
  static const int kGc2ClientHelloFieldNumber = 6;
  inline const ::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello& gc2client_hello() const;
  inline ::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello* mutable_gc2client_hello();
  inline ::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello* release_gc2client_hello();
  inline void set_allocated_gc2client_hello(::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello* gc2client_hello);
 ...
 private:
  inline void set_has_version();
  inline void clear_has_version();
  inline void set_has_cstrike15_welcome();
  inline void clear_has_cstrike15_welcome();
  inline void set_has_location();
  inline void clear_has_location();
  inline void set_has_gc2client_hello();
  inline void clear_has_gc2client_hello();
  ...
  ::CMsgCStrike15Welcome* cstrike15_welcome_;
  ...
  ::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello* gc2client_hello_;
...
// optional .CMsgCStrike15Welcome cstrike15_welcome = 2;
inline bool CMsgClientWelcome::has_cstrike15_welcome() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void CMsgClientWelcome::set_has_cstrike15_welcome() {
  _has_bits_[0] |= 0x00000002u;
}
inline void CMsgClientWelcome::clear_has_cstrike15_welcome() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void CMsgClientWelcome::clear_cstrike15_welcome() {
  if (cstrike15_welcome_ != NULL) cstrike15_welcome_->::CMsgCStrike15Welcome::Clear();
  clear_has_cstrike15_welcome();
}
inline const ::CMsgCStrike15Welcome& CMsgClientWelcome::cstrike15_welcome() const {
  return cstrike15_welcome_ != NULL ? *cstrike15_welcome_ : *default_instance_->cstrike15_welcome_;
}
inline ::CMsgCStrike15Welcome* CMsgClientWelcome::mutable_cstrike15_welcome() {
  set_has_cstrike15_welcome();
  if (cstrike15_welcome_ == NULL) cstrike15_welcome_ = new ::CMsgCStrike15Welcome;
  return cstrike15_welcome_;
}
inline ::CMsgCStrike15Welcome* CMsgClientWelcome::release_cstrike15_welcome() {
  clear_has_cstrike15_welcome();
  ::CMsgCStrike15Welcome* temp = cstrike15_welcome_;
  cstrike15_welcome_ = NULL;
  return temp;
}
inline void CMsgClientWelcome::set_allocated_cstrike15_welcome(::CMsgCStrike15Welcome* cstrike15_welcome) {
  delete cstrike15_welcome_;
  cstrike15_welcome_ = cstrike15_welcome;
  if (cstrike15_welcome) {
    set_has_cstrike15_welcome();
  } else {
    clear_has_cstrike15_welcome();
  }
...
// optional .CMsgGCCStrike15_v2_MatchmakingGC2ClientHello gc2client_hello = 6;
inline bool CMsgClientWelcome::has_gc2client_hello() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void CMsgClientWelcome::set_has_gc2client_hello() {
  _has_bits_[0] |= 0x00000020u;
}
inline void CMsgClientWelcome::clear_has_gc2client_hello() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void CMsgClientWelcome::clear_gc2client_hello() {
  if (gc2client_hello_ != NULL) gc2client_hello_->::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello::Clear();
  clear_has_gc2client_hello();
}
inline const ::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello& CMsgClientWelcome::gc2client_hello() const {
  return gc2client_hello_ != NULL ? *gc2client_hello_ : *default_instance_->gc2client_hello_;
}
inline ::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello* CMsgClientWelcome::mutable_gc2client_hello() {
  set_has_gc2client_hello();
  if (gc2client_hello_ == NULL) gc2client_hello_ = new ::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello;
  return gc2client_hello_;
}
inline ::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello* CMsgClientWelcome::release_gc2client_hello() {
  clear_has_gc2client_hello();
  ::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello* temp = gc2client_hello_;
  gc2client_hello_ = NULL;
  return temp;
}
inline void CMsgClientWelcome::set_allocated_gc2client_hello(::CMsgGCCStrike15_v2_MatchmakingGC2ClientHello* gc2client_hello) {
  delete gc2client_hello_;
  gc2client_hello_ = gc2client_hello;
  if (gc2client_hello) {
    set_has_gc2client_hello();
  } else {
    clear_has_gc2client_hello();
